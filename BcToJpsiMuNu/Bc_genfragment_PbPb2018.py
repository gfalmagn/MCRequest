...
muOSPairFilter = cms.EDFilter("MCParticlePairFilter",
...
#P cut for at least one mu+mu+ or mu-mu- pair
muSSPairFilter = cms.EDFilter("MCParticlePairFilter",
    Status = cms.untracked.vint32(1, 1),
    MinP = cms.untracked.vdouble(2.4, 2.4),
    MaxEta = cms.untracked.vdouble(2.5, 2.5),
    MinEta = cms.untracked.vdouble(-2.5, -2.5),
    ParticleCharge = cms.untracked.int32(+1),#same-charge muons
    ParticleID1 = cms.untracked.vint32(13),
    ParticleID2 = cms.untracked.vint32(13),
)
...
ProductionFilterSequence = cms.Sequence(generator*BcmuWFilter*JpsimuFilter*muSSPairFilter*muOSPairFilter*BcToJpsiToMumuFilter)
